...
public class ImportTag implements Tag {
    ...
    public String interpret(TagNode tagNode, JinjavaInterpreter interpreter) {
        ...
        try {
            ...
            interpreter.addError(new TemplateError(ErrorType.WARNING, ErrorReason.EXCEPTION, ErrorItem.TAG, "Import cycle detected for path: '" + path + "'", null, tagNode.getLineNumber(), e, BasicTemplateErrorCategory.IMPORT_CYCLE_DETECTED, ImmutableMap.of("path", path)));
            return "";
        }
